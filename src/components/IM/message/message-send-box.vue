 ...
 * @LastEditors: VSCode
 * @LastEditTime: 2021-07-26 16:17:37
-->
<template>
  <div id="message-send-box-wrapper" :style="focus ? {'backgroundColor': 'white'} : {}" @drop="dropHandler">
    <div class="send-header-bar">
      ...
      <i class="iconfont icon-zidingyi ui-hide" title="发自定义消息" @click="sendCustomDialogVisible = true"></i>
      <i class="iconfont icon-diaocha ui-hide" title="小调查" @click="surveyDialogVisible = true"></i>
      <el-dropdown>
      <span class="el-dropdown-link ui-hide">
...
import { emojiMap, emojiName, emojiUrl } from '@/utils//IM/emojiMap'
...
.group-live-icon-box {
    ...
    .group-live-icon {
      ...
      width 25px
      height 25px
      background url('../../../assets/IM/image/live-icon.png') center no-repeat
    ...
    .group-live-icon-hover {
      ...
      width 25px
      height 25px
      background url('../../../assets/IM/image/live-icon-hover.png') center no-repeat
      background-size cover
      z-index 1
    }
}
