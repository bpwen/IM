  ...
  <div class="call-container" v-if="dialling || calling || isDialled">
    ...
    <div class="call" v-if="dialling || calling">
      ...
      <div class="mask" v-show="maskShow" :class="isLocalMain ? 'small' : 'big'" @click="changeMainVideo">
        <div>
          <img class="image" src="../../../assets/IM/image/camera-max.png"/>
...
<script>
import RtcClient from '@/utils//IM/rtc-client'
import { ACTION, VERSION } from '@/utils//IM/trtcCustomMessageMap'
import { mapGetters, mapState } from 'vuex'
import { formatDuration } from '@/utils//IM/formatDuration'
...
.accept, .refuse, .videoOn, .videoOff, .micOn, .micOff
  ...
  cursor:pointer
.accept
  background center no-repeat url("../../../assets/IM/image/call.png")
  background-size 60%
  background-color $success
.refuse
  background center no-repeat url("../../../assets/IM/image/close.png")
  background-size 70%
  background-color $danger
.videoOn
  background center no-repeat url("../../../assets/IM/image/big-camera-on.png")
.videoOff
  background center no-repeat url("../../../assets/IM/image/big-camera-off.png")
.micOn
  background center no-repeat url("../../../assets/IM/image/big-mic-on.png")
.micOff
  background center no-repeat url("../../../assets/IM/image/big-mic-off.png")
.buttons
  position absolute
  z-index 20
  width 70%
