  ...
  <div class="player">
    ...
    <div id="player-container" class="video-container">
      <div style="position: absolute">
        <img src="../../../../assets/IM/image/no-video.png">
    ...
    <div class="setting-bar">
      ...
      <div>
        <div class="player-start cursor" v-if="!isPlaying" @click="resumeVideo">
          <img class="player-icon" src="../../../../assets/IM/image/web-pusher-start.png">
          <span class="play-text">观看直播</span>
        </div>
        <div class="player-start cursor" v-else @click="pauseVideo">
          <img class="player-icon" src="../../../../assets/IM/image/pause-icon.png">
...
import poster from '../../../../assets/IM/image/poster.png'
