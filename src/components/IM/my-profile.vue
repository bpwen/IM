<template>
  <div class="my-profile-wrapper">
    <el-dialog title="编辑个人资料" :visible.sync="showEditMyProfile" width="35%">
      <el-form v-model="form" label-width="100px">
        <el-form-item label="头像">
            <!-- <B-upload :url.sync="form.avatar"></B-upload> -->
            <el-image :src="form.avatar" fit="fill" :lazy="true" style="width: 178px;"></el-image>
        </el-form-item>
