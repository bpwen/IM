      ...
      <div class="footer" v-if="showMessageSendBox" >
        <div class="merger-btn"  v-if="selectMessage">
          <div  class="relay-btn" @click="singleRelay">
            <img class="relay-icon" src="../../../assets/IM/image/sig-relay.png">
            <span class="relay-title">逐条转发</span>
          </div>
          <div  class="relay-btn" @click="mergerRelay">
            <img class="relay-icon" src="../../../assets/IM/image/merger-relay.png">
            <span class="relay-title">合并转发</span>
          </div>
          <div  class="relay-btn" @click="closeSelectMessage">
            <img class="relay-icon" src="../../../assets/IM/image/close-relay.png">
    ...
    <member-profile-card />
      <el-popover
         ...
         <div class="pop-header">
           <img src="../../../assets/IM/image/back.png" v-if="mergerMessageList.length >1" class="pop-back" @click="mergerMessageBack"/>
           <span  class="title">{{mergerTitle}}</span>
           <img src="../../../assets/IM/image/close.png" class="pop-close" @click="closeMessagePop"/>
         </div>
        <transition
...
import close from '../../../assets/IM/image/close.png'
...
export default {
  ...
  watch: {
    ...
    currentConversation(v){
        if(v.toAccount != "HuNan"){
            this.showConversationProfile = true
        }else{
            this.showConversationProfile = false
        }
    }
